...
import { ShoppingBag, Sparkles, Volume2, Check, RefreshCw } from 'lucide-react';
import { ProductCatalogSkeleton } from './Skeletons';
          ...
          {loading ? (
            ...
            >
              ...
              <motion.div
                ...
                className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-12 border-b border-black/10"
              >
                <div>
              ...
              {/* Product Grid with Framer Motion scroll entrance animations */}
                ...
                {KEYBOARDS.map((kb, index) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className="bg-white rounded-2xl border border-black/[0.08] shadow-xs overflow-hidden flex flex-col justify-between group hover:border-black/20 hover:shadow-xl transition-shadow duration-300"
                    >
                      {/* Visual Header & Tags */}
